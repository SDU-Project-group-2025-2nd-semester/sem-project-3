...
namespace Backend.Migrations
{
    ...
    [Migration("20251212124917_AddHealthReminderTrackingToDesk")]
    partial class AddHealthReminderTrackingToDesk
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Data.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Data.UserCompany", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Data.Desk", b =>
                {
                    ...
                    b.HasOne("Backend.Data.Room", "Room")
                        .WithMany("Desks")
