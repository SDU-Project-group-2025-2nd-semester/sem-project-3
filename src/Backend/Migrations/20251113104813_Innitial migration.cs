        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StandingHeight = table.Column<double>(type: "double precision", nullable: false),
                    SittingHeight = table.Column<double>(type: "double precision", nullable: false),
                    HealthRemindersFrequency = table.Column<int>(type: "integer", nullable: false),
                    SittingTime = table.Column<int>(type: "integer", nullable: false),
                    StandingTime = table.Column<int>(type: "integer", nullable: false),
                    AccountCreation = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReservationIds = table.Column<List<Guid>>(type: "uuid[]", nullable: false)
                },
                constraints: table =>
                {
