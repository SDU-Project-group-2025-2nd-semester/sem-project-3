...
export default function UserSettingsPage() {
 ...
 const [sittingHeight, setSittingHeight] = useState(currentUser?.sittingHeight !== undefined && currentUser?.sittingHeight !== null ? String((currentUser.sittingHeight)/10) : "");
 const [standingHeight, setStandingHeight] = useState(currentUser?.standingHeight !== undefined && currentUser?.standingHeight !== null ? String((currentUser.standingHeight)/10) : "");
 ...
 <button onClick={handleLogout} className="px-20 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-medium">
 Logout
 </button>
 </section>
